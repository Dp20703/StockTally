...
exports.addStocks = [
  body("watchlistId")
    ...
    .isString()
    .withMessage("Watchlist ID must be a string.")
    .isMongoId()
    .withMessage("Watchlist ID must be a valid MongoDB ID."),
  ...
  body("stocks.*.stockName")
    .notEmpty()
    .withMessage("Stock name is required for each stock.")
    .isString()
  ...
  body("stocks.*.stockSymbol")
    .notEmpty()
    .withMessage("Stock symbol is required for each stock.")
    .isString()
    .withMessage("Stock symbol must be a string.")
    .trim()
    .isLength({ min: 1, max: 20 })
    .withMessage("Stock symbol must be between 1 and 20 characters."),
];
