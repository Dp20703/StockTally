...
router.post(
    ...
    watchlistValidator.createWatchlist,
    validateRequest,
...
router.delete(
    '/delete/:id',
    authMiddleware.authUser,
    watchlistValidator.deleteWatchlist,
    validateRequest,
...
router.post(
    '/add',
    authMiddleware.authUser,
    watchlistValidator.addStocks,
    validateRequest,
    watchlistController.addStocks
);

// ── Delete Stock ── DELETE /watchlist/:watchlistId/delete/stock/:stockId
router.delete(
    '/:watchlistId/delete/stock/:stockId',
    authMiddleware.authUser,
    watchlistValidator.deleteStock,
    validateRequest,
...
router.put(
    '/update/:id',
    authMiddleware.authUser,
    watchlistValidator.updateWatchlist,
    validateRequest,
